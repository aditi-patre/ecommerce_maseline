<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="Home.aspx.cs" Inherits="Home" ValidateRequest="false" %>
                    ...
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                        <div id="cssmenu" style=" right: 0;">
                            <ul>
                                ...
                                <li><a href="#">
                                    <img src="images/home/catalog.png" class="girl img-responsive" alt="" /></a></li>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    <div style="width: 100%;">
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" ><%--<div class="col-md-6 pull-left" style="margin-left: 15px; margin-right: 15px;">--%>
            <h2>
       ...
       <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3"> <%--<div class="col-md-3 pull-left" style="right: 0;">--%>
           <ul class="home_youtube_right"><%-- <ul style="padding: 0px; margin: 0px; text-align: left;">--%>
